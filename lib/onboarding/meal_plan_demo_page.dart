      ...
      TargetFocus(
        ...
        contents: [
          TargetContent(
            align: ContentAlign.bottom,
            child: Text(
              "Tap here to delete this recipe from your meal plan.",
              style: TextStyles.smallHeadingSecondary,
            ),
          ),
        ],
                  ...
                  children: [
                    ...
                    IntrinsicHeight(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "Try accepting suggested meals, dragging meals to different days, and manually adding new meals to your plan!",
