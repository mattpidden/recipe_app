...
class _RecipePageState extends State<RecipePage> {
  ...
  void _showCookedSheet(BuildContext context, Recipe recipe) async {
    await showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: AppColors.backgroundColour,
      builder: (_) =>
          CookedSheet(recipe: recipe, onSave: () => savedCookedSheet = true),
    );
    if (savedCookedSheet) {
      showCorfetti();
      savedCookedSheet = false;
    }
  }
